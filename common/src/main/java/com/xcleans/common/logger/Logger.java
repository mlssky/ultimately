...
public final class Logger {
    ...
    private static int mLevel = Config.LOG;
    ...
    private static String format(String msg, Object... args) {
        if (!TextUtils.isEmpty(msg) && null != args && msg.contains(mFlag)) {
    ...
    private static String markTag(String tag) {
        if (!TextUtils.isEmpty(tag)) { // log中有tag，以tag为准
            return tag;
        }
