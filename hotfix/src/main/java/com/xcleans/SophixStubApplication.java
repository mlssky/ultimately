...
/**
 * 如果Application已经了，那如何修复：
 *Application:已经被加载过被打上pre-verified 标志，再次加载PatchDex里面的Application 会触发异常(java.lang.IllegalAccessError:class ref in pre-verified class resolved..)
 *
 * Dalvik：使用自行研发的全量dex方案
 *
 * ART:
 *
 *
